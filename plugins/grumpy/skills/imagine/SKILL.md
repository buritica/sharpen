---
name: imagine
description: "Grumpy production imagination — behavioral audit of your diff covering happy paths per transport, state transitions, concurrency, error/cleanup, UX, logging, metrics, and edge cases including first deploy"
---
