---
name: simplify
description: "Grumpy simplify — checks the diff against code-quality thresholds judged against the merge base (new and regressed violations block; legacy debt is reported, not failed) and fixes what fails"
---
